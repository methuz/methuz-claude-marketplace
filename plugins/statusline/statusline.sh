...
# Methuz Status Line for Claude Code
# Enhanced status line with model info, git status, context usage, and last message
#
# Color theme: gray, orange, blue, teal, green, lavender, rose, gold, slate, cyan
# Change COLOR variable below to customize
...
# Separate color for folder/path
C_FOLDER='\033[38;5;136m'  # gold
...
output="${C_ACCENT}${model}${C_GRAY} | ${C_FOLDER}${dir}${C_GRAY}"
